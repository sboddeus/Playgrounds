...
// The `addCaveGlitter` function randomly places graphics in a small area. The cave glitter plays different notes and glows as you move your finger across it.
...
//#-end-localizable-zone
        shape.setOnFingerMovedHandler { touch in
        ...
        shape.accessibilityHints = AccessibilityHints(makeAccessibilityElement: true, accessibilityLabel: NSLocalizedString("CaveGlitter", comment: "AX Label: CaveGlitter"), actions: [.tap, .swipe], groupID: accessibilityGroup)
    }
}
