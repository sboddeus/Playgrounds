...
// The `addGraphicCluster` function displays the graphics in a fan shape and plays each sound as you drag your finger across it. It plays all the sounds together when you double tap on the cluster.
...
//#-localizable-zone(GraphicCluster03)
                // Double-tap the cluster to play all the sounds and make all of the graphics glow at once.
//#-end-localizable-zone
                for sound in sounds {
...
//#-localizable-zone(GraphicCluster04)
                // Tap each graphic one at a time to play its sound and make it glow individually.
//#-end-localizable-zone
...
//#-end-localizable-zone
        ...
        graphic.accessibilityHints = AccessibilityHints(makeAccessibilityElement: true, accessibilityLabel: String(format: NSLocalizedString("GraphicCluster item %d", comment: "AX Label: GraphicCluster"), count + 1), actions: [.tap, .doubleTap])
