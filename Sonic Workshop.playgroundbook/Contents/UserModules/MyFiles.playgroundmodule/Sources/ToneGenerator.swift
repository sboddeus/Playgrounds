...
//#-localizable-zone(ToneGenerator02)
    // The finger moved handler takes a touch as an argument. You can use this value to manipulate the tones being played.
//#-end-localizable-zone
...
//#-end-localizable-zone
    ...
    graphic.accessibilityHints = AccessibilityHints(makeAccessibilityElement: true, accessibilityLabel: NSLocalizedString("ToneGenerator", comment: "AX Label: ToneGenerator"), actions: [.swipe])
}
