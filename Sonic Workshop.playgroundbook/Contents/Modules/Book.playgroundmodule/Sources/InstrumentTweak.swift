...
struct InstrumentTweak {
    ...
    /// Creates an instrument tweak whose effect varies within the range startValue to endValue. Depending on where you tap the keyboard, a different value in the range will be applied.
