...
class GroupLearningBlockView: UIView {
    ...
    private func updateAX() {
        let axLabel = isDisclosed ?
            NSLocalizedString("Hide", comment: "AX label for disclose button when block is visible.") :
            NSLocalizedString("Show", comment: "AX label for disclose button when block is hidden.")
        let axHint = isDisclosed ?
            NSLocalizedString("Hides this block", comment: "AX hint for disclose button when block is visible.") :
            NSLocalizedString("Shows this block", comment: "AX hint for disclose button when block is hidden.")
