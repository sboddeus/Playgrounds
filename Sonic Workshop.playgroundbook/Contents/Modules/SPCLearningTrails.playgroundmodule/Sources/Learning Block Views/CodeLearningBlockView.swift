...
class CodeLearningBlockView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        copyButton.accessibilityLabel = NSLocalizedString("Copy code", comment: "AX label for copy code button")
        copyButton.accessibilityHint = NSLocalizedString("Copies the code in this snippet. You can then paste it into your own code.", comment: "AX hint for copy code button")
        ...
        textView.accessibilityLabel = NSLocalizedString("Code snippet", comment: "AX label for code in a code block")
