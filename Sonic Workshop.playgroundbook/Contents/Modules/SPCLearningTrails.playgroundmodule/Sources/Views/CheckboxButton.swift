...
class CheckboxButton: UIButton {
    ...
    enum CheckedState {
        ...
        var accessibilityDescription: String {
            ...
            switch self {
            case .unchecked:
                state = NSLocalizedString("unchecked", comment: "AX description of an unchecked option in a response block")
            case .chosen:
                state = NSLocalizedString("chosen", comment: "AX description of a chosen option in a response block")
            case .correct:
                state = NSLocalizedString("correct", comment: "AX description of a correct ticked option in a response block")
            case .wrong:
                state = NSLocalizedString("wrong", comment: "AX description of a wrong ticked option in a response block")
            }
            let option = NSLocalizedString("option", comment: "AX prefix of an option in a response block")
            return "\(option): \(state)"
        }
    }
    ...
    override func sizeThatFits(_ size: CGSize) -> CGSize {
        ...
        let titleSize = titleSizeThatFits(within: targetSize)
