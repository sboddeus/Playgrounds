...
public class LearningTrailViewController: UIViewController, LearningTrailController {
    ...
    private var closeButton = BarButton()
    ...
    override public func viewDidLoad() {
        ...
        closeButton.accessibilityLabel = "Hide Learning Trail"
        ...
        UIView.animate(withDuration: duration, delay: delay,
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                if let currentStepViewController = self.currentPageViewController() as? LearningStepViewController {
                    currentStepViewController.axActivate()
                }
            }
        })
    }
...
extension LearningTrailViewController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let viewController = learningTrailDataSource?.viewControllerForStep(at: indexPath.row) as? LearningStepViewController, let cell = cell as? StepCollectionViewCell {
