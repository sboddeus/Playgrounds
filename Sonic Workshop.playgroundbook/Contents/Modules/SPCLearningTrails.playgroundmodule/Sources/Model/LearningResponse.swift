...
public class LearningResponse {
    ...
    // Indicates whether the confirm button must be tapped to reveal answers.
    public private(set) var isConfirmRequired = false
    
    // Indicates whether the confirm button has been tapped.
    ...
    // If isConfirmRequired is true, the correct options must all be selected and the confirm button tapped.
