 ...
 **Goal:** Create a hypocycloid.
 ...
 You’ve just imagined a hypocycloid. Look at the live view. Can you see how the flat track from the previous page has been rolled up into a circle so the wheel rolls *inside* it? In fact, the prefix *hypo-* means: *under* or *beneath*, and you can think of the wheel as rolling *beneath* the track!
 
 * callout(Experiment):
 Edit the values below to see how the hypocycloid changes as the size of the circles change.
