 ...
 **Goal:** Create an ellipse.
 ...
 You now have all the ingredients you need to create trochoids and cycloids, of both the *hypo-* and *epi-* varieties. Your final challenge is to figure out how to draw a very special shape—an ellipse.
 ...
 * callout(Tip):
 The ellipse you’re seeing in the live view is just one possibility. Yours might be long and thin, or short and fat, or even vertical! Good luck!
 */
